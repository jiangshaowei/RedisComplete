 ...
 * @param <T>
 */
public class JedisListMap<T extends Object> extends JedisConn {

	private Class<T> clazz;

	public JedisListMap(Class<T> clazz) {
		this.clazz = clazz;
	}
	...
	public void setMapUsePipelineAndTransaction(String key,Map<String,List<T>> map){
     ...
     * @param time
     */
    public void setMapUsePipelineAndTransaction(String key,Map<String,List<T>> map ,Integer expireSec){
    ...
    public void setMapUsePipeline(String key,Map<String,List<T>> map){
     ...
     * @param time
     */
    public void setMapUsePipeline(String key,Map<String,List<T>> map ,Integer expireSec){
        if(StringUtils.isEmpty(key) || map == null || map.isEmpty()){
            return ;
        }
        Jedis jedis = null;
